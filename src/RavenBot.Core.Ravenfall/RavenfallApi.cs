...
namespace RavenBot.Core.Ravenfall
{
    public class RavenfallApi : IRavenfallApi
    {
        ...
        public Task ProceedDungeonAsync(User player) => SendAsync("dungeon_proceed", player);
        public Task KillDungeonBossAsync(User player) => SendAsync("dungeon_kill_boss", player);
        public Task KillRaidBossAsync(User player) => SendAsync("raid_kill_boss", player);
        ...
        public Task GetDungeonCombatStyleAsync(User player) => SendAsync("dungeon_skill_get", player);
        public Task GetRaidCombatStyleAsync(User player) => SendAsync("raid_skill_get", player);
